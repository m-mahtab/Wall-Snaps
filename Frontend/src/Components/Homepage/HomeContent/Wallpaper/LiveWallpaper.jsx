                    ...
                    <tbody>
                        {currentPageData.map((item) => (
                            <tr key={item.id} className="text-center border-b-2  border-gray-300 py-10">
                                ...
                                <img src={`http://localhost:5000/${item.thumbnail}`} alt={item.title} className="h-40 w-24 mx-auto rounded-lg" />
                                </td>
                                <td className="px-4 py-2">{item.category}</td>
                                <td className="px-4 py-2">{item.tags}</td>
                                <td className="type">
                                <span class="badge badge-info border-radius-5">{item.type} </span></td>
