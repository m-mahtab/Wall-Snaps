            ...
            <div className='m-2 sm:m-4 md:m-6 xl:m-8 h-auto bg-white rounded-2xl shadow-xl'>
                <div className=' h-auto border-b-2 border-slate-100 relative px-3 md:px-4 lg:px-6 py-3'>
                    <div className='h-auto py-1 md:py-2 xl:py-3 flex items-center justify-between lg:justify-start'>
                        ...
                        <button onClick={handlePreview} className='btn-shadow lg:mx-3 xl:mx-5 bg-cus-black text-white  px-3 md:px-4 lg:px-6 py-1 rounded-full font-semibold'>Preview</button>
                    </div>
                </div>  
                <div className=' px-3 md:px-4 lg:px-6 h-auto'>
                    ...
                    <button onClick={handleSaveChanges} className="mb-2 md:my-3 lg:my-4 xl:my-5 bg-cus-black text-white px-3 py-1 md:px-5  md-py-2 lg:px-7 xl:px-9 xl:py-3 rounded-full font-semibold shadow-2xl">
                        Save
                    </button>
                </div>
            </div>
